...
include_once '../../variables.php';
    ...
    $query = "SELECT ci.id_cita,ci.fecha,ci.hora, me.sufijo, me.apellidos_medi, me.nombres_medi, pa.id_paciente, pa.nombres_paci1,pa.nombres_paci2,pa.apellidos_paci1,pa.apellidos_paci2, ci.id_caso
              ...
              WHERE (ci.id = '$cita_atendida' or ci.id = '$cita_cobrada' or ci.id = '$cita_finalizada') and ca.id_medico = '$id_medico' and concat_ws(' ', pa.nombres_paci1,pa.nombres_paci2,pa.apellidos_paci1,pa.apellidos_paci2) like '%$paciente%' ORDER BY ci.fecha DESC";
