...
include_once '../../variables.php';
    ...
    $query = "SELECT ci.id_cita,ci.fecha,ci.hora, me.sufijo, me.apellidos_medi, me.nombres_medi, pa.nombres_paci1,pa.nombres_paci2,pa.apellidos_paci1,pa.apellidos_paci2, ci.id_caso
              FROM cita as ci
