...
<head>
    ...
    <title>Perfil Recepcionista</title>
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-3 bg-c-lite-green user-profile abs-center">
                                    <div class="card-block text-center text-white">
                                        <h6 hidden id="id_recepcionista">Aquí va el ID</h6>
                                        <div class="m-b-25">
                                        ...
                                        <p class="my-1 text-uppercase" id="rol_card">recepcionista</p>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 my-2">
                                                ...
                                                <h6 class="text-muted f-w-400" id="nombres_rece"></h6>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600">Apellidos:</p>
                                                <h6 class="text-muted f-w-400" id="apellidos_rece"></h6>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600">Cédula:</p>
                                                <p class="text-muted f-w-400" id="cedula_rece"></p>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600">Teléfono:</p>
                                                <h6 class="text-muted f-w-400" id="telefono_rece">N/A</h6>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600">Celular:</p>
                                                <h6 class="text-muted f-w-400" id="celular_rece"></h6>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600">Correo:</p>
                                                <h6 class="text-muted f-w-400" id="correo_rece"></h6>
                                            </div>
                                            <div class="col-sm-12 my-2">
                                                <p class="m-b-10 f-w-600">Dirección:</p>
                                                <h6 class="text-muted f-w-400" id="direccion_rece"></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
