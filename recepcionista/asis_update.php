...
<head>
    ...
    <title>Actualizar Perfil de Asistente</title>


    <!-- Template CSS -->
    <link rel="stylesheet" href="../assets/css/style-starter.css">
    <link rel="stylesheet" href="css/rece.css">
    <link rel="stylesheet" href="css/asis_update.css">
...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-3 bg-c-lite-green user-profile abs-center">
                                    <div class="card-block text-center text-white">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <div class="m-l-20">
                                                <h7 id="estado_asis" class="my-1"></h7>
                                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">DATOS PERSONALES - asistente</h6>
                                        <div class="row">
                                        <input type="text" id="id_asis" value="<?php echo($id_asistente);?>" required hidden>
                                        <input type="text" id="id_usu" value="<?php echo($id_usuario);?>" required hidden>
                                            <div class="col-sm-6 my-2">
                                                ...
                                                <input type="text" class="text-muted f-w-400 form-control" id="nombres_asis" size="50" maxlength="50" required>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600"><span style="color: red;">*</span>Apellidos:</p>
                                                <input type="text" class="text-muted f-w-400 form-control" id="apellidos_asis" size="50" maxlength="50" required>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600"><span style="color: red;">*</span>Cédula:</p>
                                                <input type="text" class="text-muted f-w-400 form-control" id="cedula_asis" ondrop=" return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" size="10" maxlength="10" required>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600">Teléfono:</p>
                                                <input type="text" class="text-muted f-w-400 form-control" id="telefono_asis" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" size="15" maxlength="15">
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600"><span style="color: red;">*</span>Celular:</p>
                                                <input type="tel" class="text-muted f-w-400 form-control" id="celular_asis" pattern="[0-9]{10}" size="10" maxlength="10" autocomplete="of" required>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600"><span style="color: red;">*</span>Correo:</p>
                                                <input type="email" class="text-muted f-w-400 form-control" id="correo_asis" size="50" maxlength="50" required>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                                <p class="m-b-10 f-w-600"><span style="color: red;">*</span>Dirección:</p>
                                                <input type="text" class="text-muted f-w-400 form-control" id="direccion_asis" size="100" maxlength="100" required>
                                            </div>
    ...
    <script src="js/asis_update.js"></script>
