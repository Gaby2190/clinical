...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        ...
                                        <form id="paciente-datos" enctype="multipart/form-data">
                                                <div class="row form-group"><div class="col-sm-6 my-2">
                                                ...
                                                <div class="col-sm-6 my-2">
                                                    ...
                                                    <input type="text" class="text-muted f-w-400 form-control" id="cedula_paci" name="cedula_paci" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" size="10" maxlength="10" required>
                                                </div>
                                                <div class="col-sm-6 my-2">
                                                ...
                                                <div class="col-sm-6 my-2">
                                                    ...
                                                    <!-- <input type="text" class="text-muted f-w-400 form-control" id="gcultural_paci" size="50" maxlength="50" required> -->
                                                    <select class="custom-select" id="select_gcultural" required>
                                                        ...
                                                        <option value="3" selected>Mestizo/a</option>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-sm-12 my-2">
                                                    <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit">Referencia personal del paciente</h6>
                                                </div>
                                                ...
                                                <div class="col-sm-6 my-2">
                                                    <p class="m-b-10 f-w-600"><span style="color: red;">*</span>Parentesco - Afinidad:</p>
                                            ...
                                            <!-- <div class="col-sm-12 my-4">
                                                <button class="btn btn-primary text-uppercase btn-lg float-right my-4" id="test">Prueba Cedula</button>
                                            </div> -->
                                        </form>
                                    </div>
                                </div>
    ...
    <script src="js/paci_create.js"></script>
