        ...
        $.ajax({
            ...
            success: function(response) {
                if (response != false) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) { 
                            ...
                            var html = '<div class="alert alert-success alert-dismissible" role="alert">'+
                                '   <strong>Datos ya registrados en CLINICAL</strong>'+
                    ...
                    const id_usuario = $('#cedula_paci').val();
                    
                    $.ajax({
                        type: "POST",
                        url: '../php/paciente/paciente-list-dat-dg.php',
                        data: { id_usuario },
                        success: function(response) { 
                            if (JSON.parse(response)==null)
                            {
                                document.getElementById('notificacion').innerHTML = '';
                                var html = '<div class="alert alert-primary alert-dismissible" role="alert">'+
                                    '   <strong>Paciente no existe, porfavor solicite la información</strong>'+
                                    '       <button class="close" type="button" data-dismiss="alert" aria-label="Close">'+
                                    '           <span aria-hidden="true">×</span>'+
                                    '       </button>'
                                    '   </div>';
                            ...
                            var html = '<div class="alert alert-warning alert-dismissible" role="alert">'+
                                '   <strong>Datos obtenidos de DATA-GROUP, porfavor verifique..!</strong>'+
                                '       <button class="close" type="button" data-dismiss="alert" aria-label="Close">'+
                                '           <span aria-hidden="true">×</span>'+
                                '       </button>'
                                '   </div>';
