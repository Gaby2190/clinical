$(document).ready(function() {
    ...
    function listarCitas(txt){
        ...
        $.ajax({
            type: "POST",
            data: {txt_search},
            url: "../php/historial_citas/historial_citas-get.php",
            beforeSend: function() {
            ...
            success: function (response) {
                ...
                if (response == false) {
                    ...
                    resp.forEach(r => {
                        ...
                        template += `<tr class="bg-blue" citaID="${id_cita}">
                                        ...
                                        <td class="pt-3"><a href="#" style="color: #fff" class="btn btn-primary btn-sm" id="certificado_m">Certificado</a><br/>
                                        <a href="#" style="color: #fff" class="btn btn-secondary btn-sm" id="receta_m">Receta</a><br/>
                                        <a href="reporte_alta.php?id_caso=${r.id_caso}" target="_blank" style="color: #fff" class="btn btn-success btn-sm">Reportes</a></td>
                                    </tr>
                                    <tr id="scitang-row">
                                        <td></td>
                                    </tr>`;
