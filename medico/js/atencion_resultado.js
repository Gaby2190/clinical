...
//OJO
    ...
    $("#btn_guardar").click(function(e) {
        ...
        if (Number(tipo_cita_g) === 0) {
            if ((($("#motivo_consulta").val() == "")&&(!$("#motivo_consulta").attr('disabled'))) || (($("#problema_actual").val() == "")&&(!$("#problema_actual").attr('disabled'))) || cont_diag == 0 || $("#evolucion").val() == "") {
                $('#texto_modal').html('Ingrese los valores obligatorios');
                $('#modal_icon').attr('style', "color: orange");
                $('#modal_icon').attr("class", "fa fa-exclamation-circle fa-4x animated rotateIn mb-4");
                $('#modalPush').modal("show");
