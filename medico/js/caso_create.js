        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                medicos.forEach(medico => {
                    ...
                    let nom_ape = medico.sufijo + " " + apellido + " " + nombre;
                    if (medico.id_medico == id_medico) {
                        template += `
                        <option value="${id_medico}" selected="selected">${nom_ape}</option>
                        `;
                    }else{
                        template += `
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response != false) {
                    ...
                    $('#pregunta_modal').html("El paciente tiene un Caso Abierto para el m&eacute;dico y especialidad indicados. <br/> Consulte al paciente si es una cita de control. <br/> Porfavor Seleccione el tipo de cita que desea el paciente.");
