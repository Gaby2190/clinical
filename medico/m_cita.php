...
<head>
    ...
    <title>Modificación Cita</title>


    <!-- Template CSS -->
    <link rel="stylesheet" href="../assets/css/style-starter.css">
    <link rel="stylesheet" href="css/medi.css">
    <link rel="stylesheet" href="css/m_cita.css">
...
<body class="sidebar-menu-collapsed">
                                ...
                                <div class="col-sm-12"> 
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 my-2">
                                                <button id='cp_nervioso' style="color: #fff" class="btn btn-primary btn-sm" disabled>CP</button><button id='sp_nervioso' style="color: #fff" class="btn btn-secondary btn-sm" disabled>SP</button>
                                            </div>
                                            <div class="col-sm-6 my-2">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 table-responsive">
                                                ...
                                                <button class="btn btn-secondary" data-toggle="modal" style="color: #fff" data-target="#modalAdicionales" id="adic_btn"><span class="fa fa-plus"></span> Añadir adicional</button>
                                            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body mx-3">
                                ...
                                <div class="input-group my-3">
                                    <p class="f-w-600 text-uppercase col-sm-12"><span style="color: red;">*</span>Diagnóstico Específico:</p>
    ...
    <script src="js/m_cita.js"></script>
