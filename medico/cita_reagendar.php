...
<head>
    ...
    <link rel="stylesheet" href="css/cita_reagendar.css">
...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">registro de reagendamiento de citas</h6>
                                        <form id="cita-datos">
                                            <div class="container">
                                                <div class="row form-group">
                                                    <div class="col-sm-8 my-2">
                                                        <input type="text" class="form-control" id="id_cita" value="<?php echo($id_cita);?>" required hidden>
                                                    ...
                                                    <div class="col-sm-4 mt-4 pt-3 my-2 pb-0 d-flex">
                                                        <a style="color: #fff;" class="btn btn-secondary" id="gen_citas"><span class="fa fa-calendar-check-o"></span> Generar Citas</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
    ...
    <script src="js/cita_reagendar.js"></script>
