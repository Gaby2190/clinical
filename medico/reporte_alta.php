...
<head>
    ...
    <title>Reportes del Alta Médica</title>


    <!-- Template CSS -->
    <link rel="stylesheet" href="../assets/css/style-starter.css">
    <link rel="stylesheet" href="css/medi.css">
    <link rel="stylesheet" href="css/reporte_alta.css">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12"> 
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">Descargar reportes del Caso</h6>
                                        <input type="text" id="id_caso" value="<?php echo($id_caso);?>" required hidden>
                                        <div class="row my-2">
...
<?php include_once("footer.php") ?>
    ...
    <script src="js/reporte_alta.js"></script>
