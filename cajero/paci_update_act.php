...
if (trim($_SESSION['rol']) != trim($caje)) {
...
<head>
    ...
    <title>Actualizar Perfil de Paciente</title>


    <!-- Template CSS -->
    <link rel="stylesheet" href="../assets/css/style-starter.css">
    <link rel="stylesheet" href="css/caje.css">
    <link rel="stylesheet" href="css/paci_update_act.css">
...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                        <input type="text" id="id_paci" value="<?php echo($id_paciente);?>" required hidden>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12 my-2 justify-content-right">
                                        <button class="btn btn-primary rounded float-right my-4" id="btn_datos"><span class="fa fa-pencil-square-o"></span> ACTUALIZAR</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="js/caje.js"></script>

    <script src="js/paci_update_act.js"></script>
