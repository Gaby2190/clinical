...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">Pagos Realizados</h6>
                                        <div class="container">
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col-12 table-responsive">
                                                                    <table class="table table-striped" id="hpagos_table">
                                                                        <thead>
                                                                            <tr>
    ...
    <script src="js/historial_pagos.js"></script>
