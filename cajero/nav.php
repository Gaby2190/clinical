...
<div class="sidebar-menu sticky-sidebar-menu">
    ...
    <div class="logo-icon text-center">
        <a href="caje.php" title="logo"><img src="../assets/images/logo_cesmed.png" alt="logo-icon" style="height:47px;""> </a>
    </div>
    <!-- //logo end -->
    ...
    <input type="text" id="id_usuario" value="<?php echo($_SESSION["id_usuario"]);?>" hidden>
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
            <li class="active"><a href="caje.php"><i class="fa fa-tachometer"></i><span>Dashboard</span></a>
            </li>
            <li class="menu-list">
    ...
    <div class="menu-right">
        <div class="navbar user-panel-top">
            <div class="search-box">
                <p style="color: #22445d; font-family: sans-serif; font-size: 20px;" id="rol_usr"><span class="fa fa-money"></span> CAJERO</p>
            </div>
