...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">Historial Médico</h6>
                                        <div class="container">
                                            <div class="row form-group">
                                                <div class="col-sm-2 my-3"></div>
                                                <div class="col-sm-4 my-3">
                                                    <p class="m-b-10 f-w-600 text-uppercase">Búscar por Paciente:</p>
                                                </div>
                                                <div class="col-sm-4 my-3">
                                                    <a style="color: #fff;" class="btn btn-primary" id="list_paci"><span class="fa fa-user"></span> Seleccionar Paciente</a>
                                                </div>
                                                <div class="col-sm-2 my-3"></div>
                                                <br><hr><br>
                                                <div class="container my-3" id="div_table_altas">
                                                    <div class="row form-group">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col-12 table-responsive">
                                                                    <table class="table table-striped" id="altas_table">
                                                                        <thead>
                                                                            <tr>
    ...
    <script src="js/altas_medicas.js"></script>
