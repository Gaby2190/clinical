...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">Formulario - Sala de Espera</h6>
                                        <form id="citas-datos">
                                            <div class="container">
                                                <div class="row form-group">
                                                    <div class="col-sm-3 my-2 pt-2">
                                                        <p class="m-b-10 f-w-600 text-uppercase"><span style="color: red;">*</span>Seleccione un Médico:</p>
                                                    </div>
                                                    <div class="col-sm-7 my-2 pt-1">
                                                        <select class="custom-select" id="select_medico" required></select>
                                                    </div>
                                                    <div class="col-sm-2 mt-2 pt-1">
                                                        <a style="color: #fff;" class="btn btn-primary" id="list_espera"><span class="fa fa-list"></span> Mostrar Citas</a>
                                                    </div>
                                                    <br>

                                                    <div class="container" id="div_table_citas">
                                                    <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600 tit">Citas en sala de espera</h6>
                                                        <div class="row form-group">
                                                            <div class="container">
                                                                <div class="row">
                                                    ...
                                                    <div class="container" id="div_table_resultados">
                                                    <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600 tit">Citas para resultados</h6>
                                                        <div class="row form-group">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-12 table-responsive">
                                                                        <table class="table table-striped" id="table_resultados">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th scope="col" hidden>ID</th>
                                                                                    <th scope="col">Fecha</th>
    ...
    <script src="js/sala_espera.js"></script>
