...
<head>
    ...
    <link rel="stylesheet" href="css/espe_update.css">
...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">nombre - especialidad</h6>
                                        <div class="row">
                                        <input type="text" id="id_espe" value="<?php echo($id_espe);?>" required hidden>
                                            <div class="col-sm-12 my-2">
                                                <p class="m-b-10 f-w-600"><span style="color: red;">*</span>Especialidad:</p>
                                                <input type="text" class="text-muted f-w-400 form-control" id="especialidad" size="100" maxlength="100" required>
                                            </div>
    ...
    <script src="js/espe_update.js"></script>
