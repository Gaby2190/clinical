...
<head>
    ...
    <title>Actualizar Perfil de Cajero</title>


    <!-- Template CSS -->
    <link rel="stylesheet" href="../assets/css/style-starter.css">
    <link rel="stylesheet" href="css/admin.css">
    <link rel="stylesheet" href="css/caje_update.css">
...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-3 bg-c-lite-green user-profile abs-center">
                                    <div class="card-block text-center text-white">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <div class="m-l-20">
                                                <h7 id="estado_caje" class="my-1"></h7>
                                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">DATOS PERSONALES - cajero</h6>
                                        <div class="row">
                                        <input type="text" id="id_caje" value="<?php echo($id_cajero);?>" required hidden>
                                        <input type="text" id="id_usu" value="<?php echo($id_usuario);?>" required hidden>
                                            ...
                                            <div class="col-sm-6 my-2">
                                                ...
                                                <input type="text" class="text-muted f-w-400 form-control" id="cedula_caje" ondrop=" return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" size="10" maxlength="10" required>
                                            </div>
                                            <div class="col-sm-6 my-2">
    ...
    <script src="js/caje_update.js"></script>
