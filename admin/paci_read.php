...
<head>
    ...
    <link rel="stylesheet" href="css/paci_read.css">
...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">listado - pacientes</h6>
    ...
    <script src="js/paci_read.js"></script>
