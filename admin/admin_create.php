...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">datos personales - administrador/a</h6>
                                        <form id="administrador-datos" enctype="multipart/form-data">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-6 my-2">
                                                    ...
                                                    <input type="text" class="text-muted f-w-400 form-control" id="cedula_admin" name="cedula_admin" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" size="10" maxlength="10" required>
                                                </div>
                                                <div class="col-sm-6 my-2">
    ...
    <script src="js/admin_create.js"></script>
