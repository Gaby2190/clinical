...
<body class="sidebar-menu-collapsed">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12"> 
                                    <div class="card-block">
                                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600 tit text-uppercase">Registro de nuevo Seguro</h6>
                                        <form id="aseguradora-datos" enctype="multipart/form-data">
    ...
    <script src="js/segu_create.js"></script>
