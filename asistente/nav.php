...
<div class="sidebar-menu sticky-sidebar-menu">
    ...
    <div class="logo-icon text-center">
        <a href="asis.php" title="logo"><img src="../assets/images/logo_cesmed.png" alt="logo-icon" style="height:47px;""> </a>
    </div>
    <!-- //logo end -->
    ...
    <input type="text" id="id_usuario" value="<?php echo($_SESSION["id_usuario"]);?>" hidden>
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
            <li class="active"><a href="asis.php"><i class="fa fa-tachometer"></i><span>Dashboard</span></a>
            </li>
            <li class="menu-list">
            ...
            <li class="active"><a href="actualizacion.php"><i class="fa fa-user-circle"></i><span>Actualización de Datos</span></a>
            </li>
        </ul>
        <!-- //sidebar nav end -->
        <!-- toggle button start -->
    ...
    <div class="menu-right">
        <div class="navbar user-panel-top">
            <div class="search-box">
                <p style="color: #22445d; font-family: sans-serif; font-size: 20px;" id="rol_usr"><span class="fa fa-user-circle"></span> ASISTENTE</p>
            </div>
